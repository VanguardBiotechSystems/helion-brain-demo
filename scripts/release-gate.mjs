 ...
 * secretos en archivos versionados, presupuesto de prompt (≤7400) y que el
...
// 5) Presupuesto de prompt (≤7400 tras persona v2) — vía el test dedicado, ya
//    cubierto arriba, pero se reafirma de forma explícita.
run("Presupuesto de prompt (≤7400)", "npx vitest run tests/personality.test.ts", { });
